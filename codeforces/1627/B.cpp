...
ll manhatton_distance(ll x1, ll y1, ll x2, ll y2) {
...
void solve() {
    ...
    For (i, 1, n+1) {
        For (j, 1, m+1) {
            a = manhatton_distance(1, 1, i, j);
            b = manhatton_distance(1, m, i, j);
            c = manhatton_distance(n, 1, i, j);
            d = manhatton_distance(n, m, i, j);
            vc.push_back(max({a, b, c, d}));
        }
    }

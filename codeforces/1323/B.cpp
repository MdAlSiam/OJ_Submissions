...
int  main(){
    ...
    for(long long int  i = 1; i <= n; i++)
        scanf("%lld", ara+i);
//    cout << "ara inputted" << endl;
    for(long long int  i = 1; i <= m; i++)
        scanf("%lld", bra+i);
//    cout << "bra inputted" << endl;
    ...
    for(long long int  i = 2; i <= m; i++)
        csb[i] = csb[i-1]+bra[i];
    csa[0] = csb[0] = 0;
//    cout << "css calculated" << endl;
//    for(long long int  i = 0; i <= n; i++) cout << csa[i] << " ";
//    cout << endl;
//    for(long long int  i = 0; i <= m; i++) cout << csb[i] << " ";
//    cout << endl;
...
//    for(long long int  i = 0 ; i < index; i++) cout << factors[i] << " ";
//    cout << endl;
